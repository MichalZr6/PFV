...
int main(array < String^ > ^ args)
{
	...
	ProjektFaktury::ProgramForm form;
...
System::Void ProjektFaktury::ProgramForm::btnAdd_Click(System::Object ^ sender, System::EventArgs ^ e)
{
...
System::Void ProjektFaktury::ProgramForm::btnSplit_Click(System::Object^  sender, System::EventArgs^  e)
{
...
System::Void ProjektFaktury::ProgramForm::ProgramForm_Load(System::Object ^ sender, System::EventArgs ^ e)
{
...
System::Void ProjektFaktury::ProgramForm::txtCompany_TextChanged(System::Object ^ sender, System::EventArgs ^ e)
{
...
System::Void ProjektFaktury::ProgramForm::txtCompany_PreviewKeyDown(System::Object ^ sender, System::Windows::Forms::PreviewKeyDownEventArgs ^ e)
{
	PrevCompInvKeyDown(sender, e);
}
System::Void ProjektFaktury::ProgramForm::txtInvest_TextChanged(System::Object ^ sender, System::EventArgs ^ e)
{
	rtxtDynamicOutput->Clear();
	Globals::currShown.clear();
...
System::Void ProjektFaktury::ProgramForm::txtInvest_PreviewKeyDown(System::Object^  sender, System::Windows::Forms::PreviewKeyDownEventArgs^  e)
{
	PrevCompInvKeyDown(sender, e);
}
System::Void ProjektFaktury::ProgramForm::btnDeleteLast_Click(System::Object^  sender, System::EventArgs^  e)
{
	Globals::curr_file--;
...
System::Void ProjektFaktury::ProgramForm::btnSaldeo_Click(System::Object^  sender, System::EventArgs^  e)
{
...
System::Void ProjektFaktury::ProgramForm::lblCurrentFile_MouseHover(System::Object^  sender, System::EventArgs^  e)
{
...
void ProjektFaktury::ProgramForm::InitDynamicOutputBox()
{
...
void ProjektFaktury::ProgramForm::StringsToOutput(const std::wstring &search, 
...
void ProjektFaktury::ProgramForm::PrevCompInvKeyDown(System::Object ^ sender, 
...
void ProjektFaktury::ProgramForm::LoadRawFiles(void)
{
...
void ProjektFaktury::ProgramForm::AskForPath(void)
{
...
void ProjektFaktury::ProgramForm::LoadXLSRecords(void)
{
...
void ProjektFaktury::ProgramForm::ManageForm(FormState state)
{
...
void ProjektFaktury::ProgramForm::CheckActFile(void)
{
	if (Globals::curr_file == Globals::files.cend())
	{
...
void ProjektFaktury::ProgramForm::SetFvInfoFromInputs(FvInfo & fv)
{
	std::string errmsg{ "" };
...
void ProjektFaktury::ProgramForm::HideFvComponents(void)
{
	cbTax->Visible = false;
...
void ProjektFaktury::ProgramForm::ShowFvComponents(void)
{
	cbTax->Visible = true;
	lblTax->Visible = false;
...
bool ProjektFaktury::ProgramForm::CanSplitBtnBeEnabled
...
void ProjektFaktury::ProgramForm::UpdateProgramOutput(FormState state)
{
...
void ProjektFaktury::ProgramForm::RawFilenames_ToOutput(void)
{
...
void ProjektFaktury::ProgramForm::SummaryFromXLS_ToOutput(void)
{
...
void ProjektFaktury::ProgramForm::FvFiles_ToOutput(void)
{
...
bool ProjektFaktury::ProgramForm::NewFvAdd(void)
{
	FvInfo newFvDoc;
	...
	try
	{
		...
		this->CheckForDuplicates(std::make_unique<FvInfo>(newFvDoc));
	}
	...
	Globals::vecFvFromImg.push_back(std::make_unique<FvInfo>(newFvDoc));

	return true;
}
void ProjektFaktury::ProgramForm::CheckForDuplicates(const std::unique_ptr<FvInfo> &fv)
{
	...
	{
		e = gcnew System::Exception(wstrtoustr(L"Faktura firmy [" + (*prog_s)->GetCompany() + L"] o numerze [" + (*prog_s)->GetInvoiceNumber()
			+ L"] zosta³a ju¿ dodana w tej sesji programu."));
		throw e;
	}
	else if (base_s != Globals::fv_list.vecOldFvInfo.end())
	{
		e = gcnew System::Exception(wstrtoustr(L"Faktura firmy [" + (*base_s)->GetCompany() + L"] o numerze [" + (*base_s)->GetInvoiceNumber()
			+ L"] zosta³a ju¿ wczytana z pliku .xls."));
		throw e;
	}
}
bool ProjektFaktury::ProgramForm::NewNonFvAdd(void)
{
...
bool ProjektFaktury::ProgramForm::AnotherPageAdd(void)
{
...
bool ProjektFaktury::ProgramForm::PromptForSaving(void)
{
...
void ProjektFaktury::ProgramForm::SaveToFile(void)
{
...
void ProjektFaktury::ProgramForm::RenameAllFiles(void)
{
...
void ProjektFaktury::ProgramForm::ResetFilenameLabel(void)
{
...
void ProjektFaktury::ProgramForm::InitOnMouseHoverTextBox(void)
{
...
std::wstring ProjektFaktury::ProgramForm::TrimLongFileName(const std::wstring & fname)
{
...
void ProjektFaktury::ProgramForm::FillInForTests()
{
