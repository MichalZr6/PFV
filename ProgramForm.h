...
namespace ProjektFaktury 
{
	...
	/// <summary>
	/// Podsumowanie informacji o ProgramForm
	/// </summary>
	...
	private: 
		...
		void PrevCompInvKeyDown(System::Object^  sender, System::Windows::Forms::PreviewKeyDownEventArgs^  e);
		...
		void SetFvInfoFromInputs(FvInfo &fv);
		...
		bool NewFvAdd(void);
		void CheckForDuplicates(const std::unique_ptr<FvInfo> &fv);	//throws if there are duplicates: in program input or in data loaded from xls file
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->btnAdd->Click += gcnew System::EventHandler(this, &ProgramForm::btnAdd_Click);
			// 
			// label1
			// 
			...
			this->txtCompany->TextChanged += gcnew System::EventHandler(this, &ProgramForm::txtCompany_TextChanged);
			this->txtCompany->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &ProgramForm::txtCompany_KeyPress);
			this->txtCompany->Leave += gcnew System::EventHandler(this, &ProgramForm::txtCompany_Leave);
			this->txtCompany->PreviewKeyDown += gcnew System::Windows::Forms::PreviewKeyDownEventHandler(this, &ProgramForm::txtCompany_PreviewKeyDown);
			// 
			// txtFvIdent
			// 
			...
			this->txtInvest->TextChanged += gcnew System::EventHandler(this, &ProgramForm::txtInvest_TextChanged);
			this->txtInvest->KeyPress += gcnew System::Windows::Forms::KeyPressEventHandler(this, &ProgramForm::txtInvest_KeyPress);
			this->txtInvest->Leave += gcnew System::EventHandler(this, &ProgramForm::txtInvest_Leave);
			this->txtInvest->PreviewKeyDown += gcnew System::Windows::Forms::PreviewKeyDownEventHandler(this, &ProgramForm::txtInvest_PreviewKeyDown);
			// 
			// rtxtProgramOutput
			// 
			...
			this->btnSplit->Click += gcnew System::EventHandler(this, &ProgramForm::btnSplit_Click);
			// 
			// label5
			// 
			...
			this->txtNetVal->Enter += gcnew System::EventHandler(this, &ProgramForm::txtNetVal_Enter);
			this->txtNetVal->Leave += gcnew System::EventHandler(this, &ProgramForm::txtNetVal_Leave);
			// 
			// label6
			// 
			...
			this->txtGrossVal->Enter += gcnew System::EventHandler(this, &ProgramForm::txtGrossVal_Enter);
			this->txtGrossVal->Leave += gcnew System::EventHandler(this, &ProgramForm::txtGrossVal_Leave);
			// 
			// panelTop
			// 
			...
			this->btnDeleteLast->Click += gcnew System::EventHandler(this, &ProgramForm::btnDeleteLast_Click);
			// 
			// btnExit
			// 
			...
			this->btnExit->Click += gcnew System::EventHandler(this, &ProgramForm::btnExit_Click);
			// 
			// chbIsFv
			// 
			...
			this->chbIsFv->CheckedChanged += gcnew System::EventHandler(this, &ProgramForm::chbIsFv_CheckedChanged);
			this->chbIsFv->Enter += gcnew System::EventHandler(this, &ProgramForm::chbIsFv_Enter);
			this->chbIsFv->Leave += gcnew System::EventHandler(this, &ProgramForm::chbIsFv_Leave);
			// 
			// lblCurrFileStatic
			// 
			...
			this->lblCurrentFile->MouseLeave += gcnew System::EventHandler(this, &ProgramForm::lblCurrentFile_MouseLeave);
			this->lblCurrentFile->MouseHover += gcnew System::EventHandler(this, &ProgramForm::lblCurrentFile_MouseHover);
			// 
			// txtNewNotFvFilename
			// 
			...
			this->btnSaldeo->Click += gcnew System::EventHandler(this, &ProgramForm::btnSaldeo_Click);
			// 
			// folderBrowser
			// 
			...
			this->ukryjPanelGórnyToolStripMenuItem->CheckedChanged += gcnew System::EventHandler(this, &ProgramForm::ukryjPanelGórnyToolStripMenuItem_CheckedChanged);
			// 
			...
			this->ukryjKomunikatyProgramuToolStripMenuItem->CheckedChanged += gcnew System::EventHandler(this, &ProgramForm::ukryjKomunikatyProgramuToolStripMenuItem_CheckedChanged);
			// 
			// miHelp
			// 
			...
			this->Load += gcnew System::EventHandler(this, &ProgramForm::ProgramForm_Load);
...
#pragma endregion
	...
	void ProgramForm_Load(System::Object^  sender, System::EventArgs^  e);
